...
3.	**Data Binding:** Mengirim data array judul buku dari 
Controller ke View menggunakan Laravel Blade. 
...
2.	**Halaman Detail Buku:** 
   Akses URL: `http://localhost:8000/koleksi/{id}` (Contoh: 
`/koleksi/101`)   
...
4. ## Dokumen Word
- [Laporan Quiz (DOCX)](docs/5a-5d_Quiz__MODUL%20PRAKTIKUM%20CONTROLLER.docx)
